...
public class TransformaTelefone {
	public static void main (String[] args){
		...
		try {
			...
			System.out.println("Arquivo não foi encontrado" + lista.toString());
		} catch (IOException e) {
			System.out.println("Arquivo não pode ser lido" + lista.toString());
		}
		finally{
			if(escrevendo != null){
				try {
					...
					System.out.println("Arquivo não pode ser lido" + listaNova.toString());
				}
			}
			if(lendo != null){
				try {
